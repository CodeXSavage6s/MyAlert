export function applyToastPosition(container, position = "bottom-right") {
    // Remove any existing position classes
    container.classList.remove("toast-bottom-right", "toast-bottom-left", "toast-top-right", "toast-top-left", "toast-center");
